...
object MockBookings {
    val bookings = listOf(
        Booking(
            id = "booking-001",
            assetId = "asset-013",
            requesterId = MockUsers.kwesiBoateng.id,
            requesterName = MockUsers.kwesiBoateng.fullName,
        ...
        Booking(
            id = "booking-002",
            assetId = "asset-002",
            requesterId = MockUsers.nanaAma.id,
            requesterName = MockUsers.nanaAma.fullName,
        ...
        Booking(
            id = "booking-003",
            assetId = "asset-006",
            requesterId = MockUsers.brightBediako.id,
            requesterName = MockUsers.brightBediako.fullName,
            ...
            notes = "Driver assigned by facilities.",
        ),
        Booking(
            id = "booking-004",
            assetId = "asset-010",
